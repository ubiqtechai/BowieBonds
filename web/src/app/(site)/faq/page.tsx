...
const FAQ_DATA = [
  {
    category: "General",
    items: [
      ["What is ZiggyDust?", "ZiggyDust is a platform that connects independent music artists with backers who license the copyright on a specific promoted work and fund YouTube ad campaigns. The license covers only that one work — not the artist's channel or catalogue. Backers earn returns — a share of the incremental channel-wide YouTube AdSense revenue. The copyright license on the work reverts to the artist when backers are made whole."],
  ...
  },
  {
    ...
    items: [
      ...
      ["What's the copyright license?", "When you back a drop, the artist grants an exclusive license on that specific promoted work's copyright — and only that work — to the backer pool. This is your collateral. If the artist defaults, you retain the license on the work. If everything goes well and you're made whole, the copyright on the work reverts to the artist automatically."],
  ...
  },
  {
    ...
    items: [
      ...
      ["What happens if an artist defaults?", "Default triggers include: missed monthly payments, YouTube OAuth revocation, content deletion, and misrepresentation. On default, backers retain the exclusive copyright license on the specific promoted work. The default is recorded permanently on the artist's track record."],
      ...
      ["How does copyright reversion work?", "When the return cap is hit or the license period expires, the exclusive copyright license on the specific promoted work automatically reverts to the artist. No action needed — it's built into the agreement. The artist regains full, unencumbered rights to that work. The license never covered anything beyond the one promoted work."],
    ],
  },
];
