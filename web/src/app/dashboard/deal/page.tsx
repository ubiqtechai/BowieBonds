...
const DOCS = [
  {
    ...
    clauses: [
      ...
      "Backer funds are a performance-linked loan to the artist — not equity, not a royalty purchase. Revenue share payments are interest.",
  ...
  },
  {
    ...
    num: "02",
    title: "The Pact",
    desc: "Performance-linked loan from Backers to Artist. Interest tied to channel-wide YouTube uplift.",
    clauses: [
      "Backer funds constitute a loan to the artist. Repayment is tied to the performance of the campaign and the artist's channel during the period the ad spend is live.",
      "Revenue share payments are interest on the loan. Principal is repaid first per the waterfall.",
      "Share applies to incremental channel-wide uplift above baseline — capturing cross-views and older content discovery.",
      "Waterfall: escrow → loan principal → interest → artist.",
      "Ends at cap or tenor expiry.",
      "Backer acknowledges total loss of loan possible.",
  ...
  },
  {
    ...
    clauses: [
      "Budget, co-pay (min 20%), min ticket, share %, cap, tenor locked.",
      "Loan terms: backer commitment is a performance-linked loan; revenue share payments are interest; principal returned first per waterfall.",
      "Channel-wide baseline computed at launch — final.",
      "Monthly payout reports; due within 15 days.",
      "Escrow controller identified; proof of spend required.",
      "Security licence optional, dormant unless default.",
    ],
  },
];
